                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                          ...
                          <g id="Icon" transform="translate(27.000000, 15.000000)">
                            ...
                            >
                              ...
                              <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-5"></use>
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">AutoHeaven</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <div class="container">
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="surname" name="surname" autofocus placeholder="Lütfen Soyadınızı Giriniz">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3 form-password-toggle">
                                <label class="form-label" for="password">Şifre Onayı</label>
                                <div class="input-group input-group-merge">
                                    <input
                                        type="password"
                                        id="password"
                            ...
                            <div class="mb-3">
                                <label for="reference" class="form-label">Referans Kodu :</label>
                                <input type="text" class="form-control" id="reference" name="reference" autofocus placeholder="Referans Kodunu Giriniz">
                            </div>
